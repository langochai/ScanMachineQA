//  EZTwain for C#.
//  XDefs translation of E:\Agent\work\d95c1da41ed9e06e\VC\Eztwain.h
...
namespace Atalasoft.EZTwain
{
    ...
    public abstract class EZTwain
    {
        ...
        [DllImport("Eztwain4.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_PreviousState")] public static extern
        int PreviousState();
        ...
        [DllImport("Eztwain4.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_RegisterAppWithProtocol")] public static extern
        void RegisterAppWithProtocol(int nMajorNum, int nMinorNum, int nLanguage, int nCountry, int nProtocolMajorNum, int nProtocolMinorNum, string sVersion, string sMfg, string sFamily, string sAppTitle);
        ...
        [DllImport("Eztwain4.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_PendingXfersCount")] public static extern
        int PendingXfersCount();
        [DllImport("Eztwain4.dll", CharSet=CharSet.Ansi, ExactSpelling=true, EntryPoint="TWAIN_PendingXfersEOJ")] public static extern
        int PendingXfersEOJ();
